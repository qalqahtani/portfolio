...
export const content: Content = {
  meta: {
    ...
    description:
      "مهندس بيانات وعالم بيانات متخصص في أنظمة التعلم الآلي وخطوط أنابيب البيانات والتحليلات الإنتاجية.",
  },
  nav: {
    logo: "قبَيِّل",
    links: [
  ...
  about: {
    ...
    sectionTitle: "من أنا",
    paragraphs: [
      "متخصص بيانات في علوم البيانات والتعلم الآلي وهندسة البيانات. يتمحور عملي حول تحويل البيانات الخام إلى أنظمة موثوقة — من بناء النماذج التنبؤية إلى نشر خطوط أنابيب الإنتاج.",
    ...
    items: [
      {
        ...
        description: [
          "بناء خطوط أنابيب ETL/ELT دُفعية وفي الوقت الفعلي باستخدام Python و Apache Airflow و Apache Kafka و Apache Spark و SQL Server، لضمان تدفق موثوق للبيانات عبر بيئات الهبوط والتجهيز والإنتاج.",
  ...
  projects: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "مشروع شخصي لبناء خط أنابيب متكامل لهندسة البيانات في الوقت الفعلي. يعتمد Apache Kafka للبث الفوري، وApache Spark لمعالجة البيانات الضخمة، وحزمة ELK للمراقبة الشاملة. مع Grafana وPrometheus لرصد أداء الخط، وKafka Schema Registry لإدارة الـ Schema والتحقق من صحته.",
